                    ...
                    <div>
                        ...
                        <Whisper placement="auto" controlId="control-id-hover" trigger="hover" speaker={<Tooltip className="bg-white text-gray-500 border shadow">
                            ...
                            <p className="flex items-center gap-2">
                                <span className="hover:text-[#F4580E]">${product?.est_shipping_cost}</span> <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 11 11" view-box="0 0 11 11" x="0" y="0" width="11" height="11" fill="#636363">
                                    <g>

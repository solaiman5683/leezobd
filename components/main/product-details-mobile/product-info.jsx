...
const ProductInfo = ({product}) => {
    ...
    return (
        <div className="bg-white">
            <div className="p-2">
                {
                    isFlashSale && <h4 className="text-sm py-2">
                        <Image src='/image/icon/mall.svg' width={22} height={8} alt="" className="inline-block h-auto -mt-1" /> {product?.name}
                    </h4>
                }

                {
                    !isFlashSale && <div className="flex justify-between">
                        ...
                        <div className="relative">
                            <Image src='/image/offer-badge.svg' width={35} height={35} alt='' />
            ...
            <Link href='/' className="flex gap-2 justify-between items-center bg-orange-100 p-2">
                {
                    isFlashSale && <div className="flex items-center text-orange-600 gap-3">
                        <HiShieldCheck size={24} />
                        <div>
                            <h6 className="text-xs">
                                Leezo Mall | 100% Authentic
                            </h6>
            ...
            <div className="flex justify-between items-center p-2">
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <Rate value={product?.rating} readOnly allowHalf color="orange" size="xs" />
                    ...
                    <div className="flex items-center text-gray-600 text-xs gap-2">
                        ...
                        <Whisper placement="auto" controlId="control-id-hover" trigger="hover" speaker={<Tooltip>
                            ...
                            *This product is also sold in other regions on <strong>Leezo</strong> platform
                        </Tooltip>}>
                            {/* <Button>Hover</Button> */}

        ...
        <div className="grid grid-cols-4 w-full">
          <div className="border-dashed h-full border-r-2 border-gray-300 flex flex-col justify-between px-6">
            ...
            {product?.shop_id !== 0 && (
              <div className="flex gap-6 text-sm">
                <button className="bg-orange-100 border border-orange-500 text-[#4F97A5] px-4 py-1 flex justify-center items-center gap-2">
                  <svg
                ...
                <Link
                  ...
                  className="border border-gray-500 text-gray-500 px-4 py-1 flex justify-center items-center gap-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="h-full flex flex-col justify-around text-sm px-6">
            <div className="flex justify-between items-center gap-4">
              ...
              <p className="text-[#4F97A5]">{product?.shop_rating}</p>
            </div>
            <div className="flex justify-between items-center gap-4">
              <p className="text-gray-500">Products</p>
              <p className="text-[#4F97A5]">{product?.shop_product_count}</p>
            </div>
          </div>
          {/* <div className='h-full flex flex-col justify-around text-sm px-6'>
                        <div className="flex justify-between items-center gap-4">
          ...
          <div className="h-full flex flex-col justify-around text-sm px-6">
            <div className="flex justify-between items-center gap-4">
              ...
              <p className="text-[#4F97A5]">{product?.shop_created_at}</p>
            </div>
            <div className="flex justify-between items-center gap-4">
              <p className="text-gray-500">Followers</p>
              <p className="text-[#4F97A5]">{product?.shop_followers}</p>
            </div>
          </div>
        </div>
      </div>

...
const MyOrderItem = () => {
    return (<div className='bg-white p-3 shadow-sm space-y-1'>
        ...
        <p className="text-xs text-gray-500">
            Placed on 11 May 2024 11:00 AM
        </p>
        <p className="flex justify-between text-xs text-gray-400">
            <span>
                Requested on 11 May 2024 11:03 AM
            </span>
        </p>
        <div className="flex gap-3 items-center w-full pt-3">
            <div className='min-w-max'>
                <Image src="/image/product/1.jpeg" alt="product" width={100} height={100} className='w-20 h-20 object-cover' />
            </div>
            ...
            <div className='w-full'>
                ...
                <div className="flex justify-between items-center w-fullmb-1">
                    ...
                    <p className='bg-orange-500 text-[11px] px-2 py-0.5 text-white italic rounded-full'>Cancelled</p>
                </div>
            </div>
        </div>

...
const MyAccountPage = () => {
    return (
        <>
            <div className='bg-white p-6 text-gray-600 hidden lg:block'>
                <div className="flex justify-between">
                    <h2 className='capitalize textLg font-bold'>My Addresses</h2>

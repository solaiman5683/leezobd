...
import FlashProductContainerDynamic from "@/components/flash-sale/flash-product-container-dynamic";
import { getFlashDealProducts } from "@/hooks/frontend/productApi";
...
const FlashSalePage = () => {
  ...
  const { data: products, isLoading } = useQuery(
    `getFlashDealProducts_${id}`,
    () => getFlashDealProducts({ id }),
    {
      enabled: !!id,
    }
  );
    ...
    <>
      <div className="hidden sm:block -z-10 ">
        <div className="bg-gray-100 space-y-6 pb-6">
          ...
          <PromotionTab /> */}
          <FlashCategoryTab />
          <FlashProductContainerDynamic products={products?.data?.data} />
        </div>

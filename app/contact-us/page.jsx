        ...
        <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
              ...
              <ul class="mt-3">
                <li class="flex items-center">
                  ...
                  <a
                    ...
                    class="text-[#F4580E] text-sm ml-3"
                  >
          ...
          <form class="ml-auo space-y-4">
            <input
              type="text"
              placeholder="Name"
              class="w-full rounded-md py-2.5 px-4 border text-sm outline-[#F4580E]"
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              placeholder="Message"
              rows="6"
              class="w-full rounded-md px-4 border text-sm pt-2.5 outline-[#F4580E]"
            ></textarea>
            <button
              type="button"
              class="text-white bg-[#F4580E] font-semibold rounded-md text-sm px-4 py-2.5 w-full"
            >
              Send
            </button>
          </form>
